...
describe(`Record Class Tests`, () => {
    ...
    test("Should get unspent record", async () => {
        ...
        let opReturnHex = "6a04" + PROTOCOL_ID + "01520101025203010017a91496e199d7ea23fb779f5764b97196824002ef811a87"
        let contractStrings = await getRecords(host, "6a04" + PROTOCOL_ID + "01520101025203010017a91496e199");
